...
class FournisseurMaterielsType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('nSerieFabricant' ,  null, ['label' => 'Numéro de Serie Fabricant',])
        ->add('nSerieFournisseur' ,  null, ['label' => 'Numéro de Serie Fournisseur',])
        ->add('lots', EntityType::class, [
            'label' => 'Numéro du Lot',
            'class' => Lots::class,
            'placeholder' => 'Selectionnez le lot de l\'appareil',
            'required' => false,'choice_label' => function ($user) {
                return $user->getId();
            }
        ])
        ;
